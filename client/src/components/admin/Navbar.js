        ...
        return (
            <>
                <NavbarMenu theme={AdminTheme}>
                    ...
                    <NavbarItem to="/admin/search/patient">
                        Sök Patient
                    </NavbarItem>
                    <NavbarItem to="/admin/register/exercise">
                        Ladda upp övning
                    </NavbarItem>
                    <NavbarItem to="/admin/search/exercise">
                        Sök övning
                    </NavbarItem>
                    <NavbarItemLogout
                        isActive={() => false}
                ...
                <StyledMobileNav open={open}>
                    <NavbarItemBurger
                        ...
                        onClick={closeMenu}
                    >
                        <StyledIcon size="1.5em" name="add_user" /> Registrera
                        Patient
                    </NavbarItemBurger>
                    <StyledDivider />
                    ...
                    <StyledDivider />
                    <NavbarItemBurger
                        to="/admin/register/exercise"
                        onClick={closeMenu}
                    >
                        <StyledIcon size="1.5em" name="upload" /> Ladda upp
                        övning
                    </NavbarItemBurger>
                    <StyledDivider />
