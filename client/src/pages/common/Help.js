        ...
        <>
            <PatientLayout>
                <StyledContainter>
                    ...
                    <p>
                        Om du har tappat bort ditt användarnamn eller QR-kod
                        måste du komma i kontakt med sjukhuset du besökte när du
                        fick ditt användarnamn eller QR-kod och be om ett nytt.
                    </p>
                    <br />
                    <p>
                    ...
                    <li>
                        Har du accepterat (ja/nej) att webbsidan får använda sig
                        av din kamera?
                    </li>
                    <li>
                        Om du inte har det, gå till din webbläsare {">"}{" "}
                        Inställningar {">"} Integritet och säkerhet {">"}{" "}
                        Webbplatsinställningar {">"} Kamera och godkänn
                        användningen av din kamera-enhet.
                    </li>
                    <li>
                        Testa att öka ljusstyrkan på skärmen du skannar din
                        QR-kod på, eller testa att öka ljusstyrkan i rummet.
                    </li>
                    ...
                    <li>
                        ...
                        Servicedesk Telefon: 077-67 30 000, knappval 2 (IT)
                        följt av 5 (övrigt).
                    </li>
                    <br />
                </StyledContainter>
